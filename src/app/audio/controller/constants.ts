...
export const AUDIO_RECEIVE_SIGNALING_IP_ENV_KEYS = [
  "NEXT_PUBLIC_AUDIO_RECEIVE_SIGNALING_IP_ADDRESS",
  "NEXT_PUBLIC_AUDIO_SIGNALING_IP_ADDRESS",
];
export const AUDIO_RECEIVE_SIGNALING_PORT_ENV_KEYS = [
...
export const DEFAULT_SIGNALING_IP_ADDRESS = getDefaultSignalingIpAddress({
  envKeys: AUDIO_RECEIVE_SIGNALING_IP_ENV_KEYS,
});

export const DEFAULT_SIGNALING_PORT = getDefaultSignalingPort({
  envKeys: AUDIO_RECEIVE_SIGNALING_PORT_ENV_KEYS,
});
