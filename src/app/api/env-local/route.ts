...
const ALLOWED_KEYS = new Set([
  ...
  "NEXT_PUBLIC_CAMERA_LEFT_EXPOSURE_COMPENSATION",
  "NEXT_PUBLIC_CAMERA_RIGHT_EXPOSURE_COMPENSATION",
  "NEXT_PUBLIC_CAMERA_LEFT_BRIGHTNESS",
  "NEXT_PUBLIC_CAMERA_RIGHT_BRIGHTNESS",
  "NEXT_PUBLIC_CAMERA_HEADING_STEP",
  "NEXT_PUBLIC_VIDEO_SPEECH_CUE_FRAME_LEFT_PERCENT",
  "NEXT_PUBLIC_VIDEO_SPEECH_CUE_FRAME_TOP_PERCENT",
  "NEXT_PUBLIC_VIDEO_SPEECH_CUE_FRAME_WIDTH_PERCENT",
  "NEXT_PUBLIC_VIDEO_SPEECH_CUE_FRAME_HEIGHT_PERCENT",
  "NEXT_PUBLIC_VIDEO_SPEECH_CUE_FRAME_LOOK_LEFT_LEFT_PERCENT",
  "NEXT_PUBLIC_VIDEO_SPEECH_CUE_FRAME_LOOK_LEFT_TOP_PERCENT",
  "NEXT_PUBLIC_VIDEO_SPEECH_CUE_FRAME_LOOK_LEFT_WIDTH_PERCENT",
  "NEXT_PUBLIC_VIDEO_SPEECH_CUE_FRAME_LOOK_LEFT_HEIGHT_PERCENT",
  "NEXT_PUBLIC_VIDEO_SPEECH_CUE_FRAME_LOOK_RIGHT_LEFT_PERCENT",
  "NEXT_PUBLIC_VIDEO_SPEECH_CUE_FRAME_LOOK_RIGHT_TOP_PERCENT",
  "NEXT_PUBLIC_VIDEO_SPEECH_CUE_FRAME_LOOK_RIGHT_WIDTH_PERCENT",
  "NEXT_PUBLIC_VIDEO_SPEECH_CUE_FRAME_LOOK_RIGHT_HEIGHT_PERCENT",
]);
